...
public class CameraFollow : MonoBehaviour
{
    ...
    private void LateUpdate() 
    {
        ...
        transform.position = new Vector3(clampedX, transform.position.y , transform.position.z); // Update the camera's position to follow player while keeping Y and Z positions unchanged
    }
}
